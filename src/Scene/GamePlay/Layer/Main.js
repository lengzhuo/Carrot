/**
 * 加载GamePlay主层信息 瓦片地图、怪物路径、萝卜对象、构建塔的面板、触摸警告节点、怪物
 * */
var GPMainLayer = cc.Layer.extend({
    ...
    onEnter: function () {
        ...
        //测试fps
        /*var fps  = [
            {cel:9,row:1,x:744,y:110},
            {cel:11,row:6,x:884,y:495},
            {cel:12,row:3,x:954,y:285},
            {cel:12,row:2,x:954,y:215},
            {cel:10,row:0,x:814,y:75},
            {cel:12,row:1,x:954,y:145},
            {cel:9,row:4,x:744,y:355},
            {cel:8,row:4,x:674,y:355},
            {cel:6,row:5,x:534,y:425},
            {cel:7,row:5,x:604,y:425},
            {cel:5,row:4,x:464,y:355},
            {cel:3,row:5,x:324,y:425},
            {cel:3,row:1,x:324,y:425},
            {cel:1,row:0,x:184,y:75},
            {cel:0,row:1,x:114,y:145},
            {cel:0,row:3,x:114,y:285},
            {cel:0,row:5,x:114,y:425},
            {cel:0,row:6,x:114,y:495},
            {cel:3,row:6,x:324,y:495},
            {cel:7,row:6,x:604,y:495},
            {cel:5,row:2,x:464,y:215},
            {cel:8,row:0,x:675,y:75},
            {cel:3,row:4,x:324,y:335},

        ];
        for(var i = 0;i<50; i++){
            var cel = Math.floor(Math.random()*12);
